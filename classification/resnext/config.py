...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'resnext'
# Model name
_C.MODEL.NAME = 'resnext50_32x4d'  # resnext101_32x8d
...
# RESNEXT parameters
_C.MODEL.RESNEXT = CN()
_C.MODEL.RESNEXT.LAYERS = [3, 4, 6, 3]
_C.MODEL.RESNEXT.GROUPS = 32
_C.MODEL.RESNEXT.WIDTH_PER_GROUP = 4
