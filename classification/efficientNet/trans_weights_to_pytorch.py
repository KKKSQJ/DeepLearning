...
def main():
    ...
    for weight in weights:
        ...
        if "stem_conv/kernel:0" == name:
            ...
            if torch_postfix in ["expand_conv.0.weight", "se.fc.0.weight", "se.fc.2.weight", "project_conv.0.weight"]: #["expand_conv.0.weight", "se.fc1.weight", "se.fc2.weight", "project_conv.0.weight"]:
