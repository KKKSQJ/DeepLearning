...
def read_split_data(data_root, save_dir, val_rate=0.2, plot_image=False):
    ...
    # 遍历文件夹，一个文件夹对应一个类别
    mnist_classes = [cla for cla in os.listdir(data_root) if os.path.isdir(os.path.join(data_root, cla))]
    # 排序，保证顺序一致
    mnist_classes.sort()
...
if __name__ == '__main__':
    read_split_data(data_root=r'D:\dataset\MNIST_Dataset\train_images', save_dir='./')
