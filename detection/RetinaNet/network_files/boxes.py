...
if __name__ == '__main__':
    # test box_iou
    boxes1 = [[10,0,54,75],[2,4,8,9],[1,2,10,56],[1,1,5,5]]
    boxes2 = [[0, 10, 14, 25], [12, 4, 18, 9], [11, 22, 19, 56],[1,1,4.9,4.9]]
    boxes1 = torch.Tensor(boxes1)
    boxes2= torch.Tensor(boxes2)
    a= box_iou(boxes1,boxes2)
    print(a)

    # test nms
    boxes = [[12, 4, 18, 9], [12, 4, 18, 9], [1, 1, 5, 5], [1, 1, 4.9, 4.9]]
    score = [0.8,0.2,0.9,0.96]
    boxes = torch.Tensor(boxes)
    score = torch.Tensor(score)
    b = nms(boxes,score,iou_threshold=0.5)
    print(b)
