...
from models.rpn_function import AnchorsGenerator, RPNHead, RegionProposalNetwork
...
if __name__ == '__main__':
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="",norm_layer=nn.BatchNorm2d,trainable_layers=3)
    model = FasterRCNN(backbone=backbone, num_classes=10)
    model.eval()
    print(model)
    y = model(x)
    print(y)